...
Любые совпадения сгенерированных ИНН, номеров счетов, названий организаций, ОГРН, ОКТМО и других данных являются случайными. Плагин не использует реальные данные для генерации — все значения создаются алгоритмически.
...
Просто вызовите окно генератора с помощью горячей клавиши для доступа к различным типам тестовых данных. Интуитивный интерфейс позволяет быстро вставлять реалистичные данные именно туда, где они нужны.
