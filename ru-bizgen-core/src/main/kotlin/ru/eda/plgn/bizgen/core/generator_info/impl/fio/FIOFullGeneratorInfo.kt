...
class FIOFullGeneratorInfo : GeneratorStrInfo(
  ...
  detailedDescription = "ФИО в полном формате: Фамилия Имя Отчество. Генерируется случайно из словарей русских имён и фамилий.",
  example = "Белов Николай Евгеньевич",
)