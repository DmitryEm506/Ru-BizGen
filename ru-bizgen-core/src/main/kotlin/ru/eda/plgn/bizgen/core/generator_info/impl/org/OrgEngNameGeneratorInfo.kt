...
class OrgEngNameGeneratorInfo : GeneratorStrInfo(
  ...
  detailedDescription = "Наименование организации на английском языке. Генерируется случайно из типовых форм собственности и названий.",
  example = "West-Platform LLC",
)